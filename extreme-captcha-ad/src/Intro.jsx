...
const Intro = ({ setView }) => {
  ...
  return (
    <section className="Intro">
      ...
      <form className={presentationStage > 3 ? 'sad' : ''}>
        ...
        {presentationStage > 1 &&
          <div className="fakeCaptcha">
            ...
            <div style={{ backgroundImage: "url(/captcha-pics/alex-kim-d52i7z91qaQ-unsplash.jpg)" }} />
            <div style={{ backgroundImage: "url(/captcha-pics/alice-butenko-GjeXWexbtlg-unsplash.jpg)" }} />
            <div style={{ backgroundImage: "url(/captcha-pics/dima-pechurin-yZ3ODX1vgrA-unsplash.jpg)" }} />
            <div style={{ backgroundImage: "url(/captcha-pics/enrico-mantegazza-B0ADZiToKgw-unsplash.jpg)" }} />
            <div style={{ backgroundImage: "url(/captcha-pics/izz-r-VKPLOCtxJRs-unsplash.jpg)" }} />
            <div style={{ backgroundImage: "url(/captcha-pics/jc-gellidon-0mDba9cPSec-unsplash.jpg)" }} />
            <div style={{ backgroundImage: "url(/captcha-pics/simon-berger-DZi0rnYrpWc-unsplash.jpg)" }} />
            <div style={{ backgroundImage: "url(/captcha-pics/valentin-lacoste-jNSJE8dMro0-unsplash.jpg)" }} />
            <div style={{ backgroundImage: "url(/captcha-pics/xviiizz-Vgv6OOwkTqc-unsplash.jpg)" }} />
          </div>
        }
      </form>
